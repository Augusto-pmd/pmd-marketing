  ...
  return (
    <div className="rounded-xl border border-white/5 bg-surface/80 backdrop-blur-xl">
      <div className="border-b border-white/5 px-5 py-4 flex items-center justify-between">
        ...
        <button
          type="button"
          className="flex items-center gap-1.5 rounded-lg border border-white/10 bg-surface-2 px-3 py-1.5 text-xs text-muted hover:border-magenta/40 hover:text-magenta transition-all"
        >
        ...
        <div>
          ...
          <div className="mt-2 grid grid-cols-2 gap-2 sm:grid-cols-5">
            {COLORS.map((c) => (
              <div
                key={c.hex}
                className="group rounded-lg border border-white/5 bg-surface-2 overflow-hidden hover:border-white/20 transition-all"
              >
                <div
